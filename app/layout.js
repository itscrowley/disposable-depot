...
export const metadata = {
  ...
  appleWebAppTitle: 'The Disposable Depot', // Mobile users ke liye
...
export default function RootLayout({ children }) {
  ...
  const websiteSchema = {
    ...
    'potentialAction': {
      '@type': 'SearchAction',
      'target': 'https://thedisposabledepot.vercel.app/?s={search_term_string}',
